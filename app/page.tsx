...
const slides = [
  { id:"products", eyebrow:"Bulk material handling", heading:"Rotary valves engineered around your material and process", description:"Sixteen product families for controlled discharge, conveying and crushing duties.", ctaLabel:"Explore products", ctaHref:"/products", image:{src:"/images/products/bzgfwf-pressure-conveying.jpeg",alt:"Industrial rotary valve"}},
  { id:"factory", eyebrow:"Manufacturing capability", heading:"From machining and welding to assembly and inspection", description:"A 6,000 m² facility in Changzhou organized across five production areas.", ctaLabel:"See manufacturing", ctaHref:"/manufacturing", image:{src:"/images/factory-panorama.jpg",alt:"Changhong ShineLong production floor"}},
