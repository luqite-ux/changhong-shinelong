...
const slides = [
  { id:"products", tone:"light" as const, eyebrow:"Bulk material handling", heading:"Rotary valves engineered around your material and process", description:"Sixteen product families for controlled discharge, conveying and crushing duties.", ctaLabel:"Explore products", ctaHref:"/products", image:{src:"/images/ai-banners/product-family-hero-v2.png",alt:"Rotary valve and conveying equipment product matrix"}, mobileImage:{src:"/images/ai-products/bzgfwk.png",alt:"Industrial rotary valve"}},
