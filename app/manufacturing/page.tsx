...
export const metadata={title:'Manufacturing & Inspection',description:'Customer-supplied evidence of machining, welding, assembly, inspection and warehouse operations in Changzhou.',alternates:{canonical:'/manufacturing'}}
